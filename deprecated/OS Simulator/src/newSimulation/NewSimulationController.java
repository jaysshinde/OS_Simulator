...
public class NewSimulationController implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        socBtn.getStyleClass().add("node-list-button");
...
//        });
        ...
        socBtn1.getStyleClass().add("node-list-button");
        ...
        socBtn2.getStyleClass().add("node-list-button");
        ...
        proBtn.getStyleClass().add("node-list-button");
        ...
        JFXButton proBtn1 = new JFXButton("Process Schedulling");
        proBtn1.setButtonType(JFXButton.ButtonType.RAISED);
        proBtn1.getStylesheets().add("/styles/styles.css");
        proBtn1.getStyleClass().add("node-list-button");
        proBtn.addEventHandler(MouseEvent.MOUSE_CLICKED, e->{
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/simulations/scheduling/scheduling.fxml"));
            } catch (IOException ex) {
                Logger.getLogger(NewSimulationController.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
        
        JFXButton proBtn2 = new JFXButton("Process Syncronisation");
        proBtn2.setButtonType(JFXButton.ButtonType.RAISED);
        proBtn2.getStylesheets().add("/styles/styles.css");
        proBtn2.getStyleClass().add("node-list-button");
        ...
        memBtn.getStyleClass().add("node-list-button");
        ...
        memBtn1.getStyleClass().add("node-list-button");
        ...
        memBtn2.getStyleClass().add("node-list-button");
...
//        memory.addAnimatedNode(memBtn3);
        ...
        diskBtn.getStyleClass().add("node-list-button");
        ...
        diskBtn1.getStyleClass().add("node-list-button");
        ...
        diskBtn2.getStyleClass().add("node-list-button");
...
//        disk.addAnimatedNode(diskBtn3);
        ...
        rtosBtn.getStyleClass().add("node-list-button");
